...
public class QrCode(string text, CodeType codeType = CodeType.LetterDigital, byte qrCodeVersion = 1)
{
    private string Text { get; } = text;
    private string Code { get; } = QrCodeBuilder.GetQrCode(text, qrCodeVersion, codeType);
...
{    
    ...
    {
        {CodeType.Digital, 10},
        {CodeType.LetterDigital, 9},
        {CodeType.Byte, 8}
    };

    private static readonly Dictionary<CodeType, string> _codeTypeMode = new()
    {
        {CodeType.Digital, "0001"},
        {CodeType.LetterDigital, "0010"},
        {CodeType.Byte, "0100"}
    };
    ...
    public static string GetQrCode(string text, byte qrCodeVersion = 1, CodeType codeType = CodeType.LetterDigital)
    {
        ...
        var tmp = codeType switch {
            CodeType.LetterDigital => CodeLetterDigital(text.ToUpper()),
            CodeType.Digital => CodeDigital(text),
            _ => CodeBytes(text)
        };
